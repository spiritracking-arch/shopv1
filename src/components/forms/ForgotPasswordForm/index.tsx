...
export const ForgotPasswordForm: React.FC = () => {
  ...
  return (
    <Fragment>
      {!success && (
        <React.Fragment>
          <h1 className="text-xl mb-4">{tUI('Forgot Password')}</h1>
      ...
      {success && (
        <React.Fragment>
          <h1 className="text-xl mb-4">{tUI('Request submitted')}</h1>
          <div className="prose dark:prose-invert">
            <p>{tUI('Check your email for a link that will allow you to securely reset your password.')}</p>
          </div>
        </React.Fragment>
      )}
    </Fragment>
